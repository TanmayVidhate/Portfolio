...
function Home() {
    ...
    return (
        <div className="w-full min-h-screen text-white px-6 sm:px-10 md:px-16 lg:px-24 py-16 
            ...
            {/* LEFT SECTION */}
            <div className="w-full lg:w-2/3 flex flex-col gap-4 fade-in-up text-center lg:text-left border border-red-700">

                <h1 className="font-bold leading-tight tracking-tight 
                               text-3xl sm:text-4xl lg:text-4xl md:text-4xl xl:text-6xl">
                    Hello, I'm{" "}
                ...
                <div className="mt-6 flex flex-wrap justify-center lg:justify-start gap-4">
                    ...
                    <a
                        ...
                        className="bg-gray-800 hover:bg-gray-700 text-white font-medium 
                                   rounded-md h-10 px-6 py-1 text-base sm:text-lg shadow-sm 

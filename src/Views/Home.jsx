...
function Home() {
    return (
        <>
            <div className='text-white  w-full justify-between items-start p-10 sm:flex-col md:p-15 lg:flex lg:flex-row lg:px-24'>
                <div className=' sm:py-5 sm:px-4 md:w-full md:pt-10'>
                ...
                <div className='sm:w-full sm:block md:w-full  '>
